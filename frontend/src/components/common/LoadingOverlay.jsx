...
export const LoadingOverlay = ({ current = 0, total = 0 }) => {
  ...
  return (
    <div className="loading-overlay">
      <div className="loading-overlay-card">
        ...
        <p className="loading-overlay-subtitle">
        ...
        {total > 0 && (
          <>
            ...
            <p className="loading-overlay-count">
              {current} / {total} schemas loaded ({percent}%)
            </p>
          </>
        )}
      </div>
