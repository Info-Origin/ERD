...
// Proper Crow's Foot SVG Component (visual only)
const CrowsFoot = ({ side = 'single' }) => {
  if (side === 'both') {
    return (
  ...
  return (
    <svg width="20" height="16" viewBox="0 0 20 16" style={{ marginTop: '2px' }}>
      {/* Single crow's foot pointing down */}
...
export const RelationshipToolbar = memo(() => {
  ...
  // MySQL Workbench 6 relationship creation modes
  const relationshipModes = [
    {
      id: "1-1-non-identifying",
      name: "1:1 Non-Identifying",
      description: "Place a new 1:1 non-identifying relationship",
      details: "Dashed line, No crow's foot, FK not part of PK, FK is UNIQUE",
      lineStyle: "dashed",
      cardinality: "1:1",
      crowsFoot: false,
      identifying: false
    ...
    {
      id: "1-n-non-identifying", 
      name: "1:N Non-Identifying",
      description: "Place a new 1:N non-identifying relationship",
      details: "Dashed line, Crow's foot on child side, FK not part of PK",
      lineStyle: "dashed",
      cardinality: "1:n",
      crowsFoot: true,
      identifying: false
    },
    {
      ...
      description: "Place a new 1:1 identifying relationship",
      details: "Solid line, No crow's foot, FK is part of PK",
      lineStyle: "solid",
      cardinality: "1:1",
      crowsFoot: false,
      identifying: true
    },
    {
      ...
      description: "Place a new 1:N identifying relationship", 
      details: "Solid line, Crow's foot on child side, FK is part of PK",
      lineStyle: "solid",
      cardinality: "1:n",
      crowsFoot: true,
      identifying: true
    },
    {
      ...
      description: "Place a new N:M identifying relationship",
      details: "Create junction table automatically, Composite primary key made of both FKs, Two solid 1:N identifying relationships",
      lineStyle: "solid",
      cardinality: "n:m",
      crowsFoot: "both",
      identifying: true
    ...
    {
      id: "existing-column",
      name: "Use Existing Column",
      description: "Place a relationship using existing column",
      details: "Detect FK existence, PK membership, UNIQUE constraint, Infer cardinality and identifying vs non-identifying, Render appropriate line style and symbols automatically",
      lineStyle: "auto",
      cardinality: "1:n",
      crowsFoot: true,
      identifying: "auto"
  ...
  const handleModeSelect = (mode) => {
    ...
    console.log(`Selected relationship mode: ${mode.name}`);
  };
