...
export const ColumnList = ({ tableName, columns }) => {
  const { 
    togglePrimaryKey, 
    toggleUnique,
    toggleNullable
  ...
  // - editingColumn, editingName state
  // - deleteColumn, renameColumn, updateColumn functions
  // - Name editing, type editing, delete functionality
  ...
  // - handleNameDoubleClick, handleNameSave, handleNameCancel, handleNameKeyDown
  // - handleTypeChange, handleDeleteColumn
