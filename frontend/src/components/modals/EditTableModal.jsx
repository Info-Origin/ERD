                    ...
                    <>
                      ...
                      {foreignKeys.some(fk => fk.isVirtual && !fk.isNew) && (
                        <button 
                          ...
                          title={!hasUnsavedChanges ? "Cannot delete saved relationships" : "Delete user-created foreign keys"}
                        >
                        Delete Foreign Key
                        </button>
                      )}
                          ...
                          editingFK === index ? (
                            ...
                            <>
                              <button 
                                ...
                                disabled={!hasUnsavedChanges}
                                title={!hasUnsavedChanges ? "Cannot edit saved relationships" : "Edit foreign key"}
                              >
                              ...
                              <button 
                                ...
                                disabled={!hasUnsavedChanges}
                                title={!hasUnsavedChanges ? "Cannot delete saved relationships" : "Delete foreign key"}
                              >
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" style={{width: '16px', height: '16px'}}>
