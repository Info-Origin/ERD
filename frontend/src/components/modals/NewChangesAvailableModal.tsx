...
interface NewChangesAvailableModalProps {
  isOpen: boolean;
  onRefresh: () => void;
  onCancel: () => void;
}

export const NewChangesAvailableModal = ({ isOpen, onRefresh, onCancel }: NewChangesAvailableModalProps) => {
    ...
    <div className="modal-overlay" onClick={onCancel}>
      <div className="modal-content new-changes-modal" onClick={e => e.stopPropagation()}>
        ...
        <div className="modal-footer">
          ...
          <Button variant="primary" onClick={onRefresh}>Refresh Now</Button>
        </div>
      </div>
    </div>
  );
