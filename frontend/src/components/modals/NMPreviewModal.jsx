          ...
          <div className="nm-preview-content">
              ...
              <div className="nm-junction-preview">
                ...
                <div className="nm-junction-columns">
                  <div className="nm-junction-column">
                    <FiKey className="column-icon pk-icon" />
                    <FiLink className="column-icon fk-icon" />
                ...
                <div className="nm-junction-note">
                  <span className="note-icon">ℹ️</span>
                  Composite Primary Key: Both columns together form the primary key
                </div>
              </div>
            </div>
            ...
            <div className="nm-preview-warning">
              ...
              <div className="warning-content">
                <strong>Note:</strong> This operation cannot be undone individually. 
                To remove this N:M relationship, you must delete the junction table and both relationships.
              </div>
            </div>
          </div>
        </div>
