...
export const getSchemas = async (connectionId) => {
...
export const getTablesAndColumns = async (connectionId, schemaName) => {
  const pool = connectionManager.getPool(connectionId);
...
export const getRelationships = async (connectionId, schemaName) => {
  const pool = connectionManager.getPool(connectionId);
...
export const getSchemaErd = async (connectionId, schemaName) => {
